...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComicStockwebApi.StockDto();
  });
  ...
  describe('StockDto', function() {
    it('should create an instance of StockDto', function() {
      // uncomment below and update the code to test StockDto
      //var instane = new ComicStockwebApi.StockDto();
      //expect(instance).to.be.a(ComicStockwebApi.StockDto);
    });
