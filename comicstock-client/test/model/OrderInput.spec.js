...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ComicStockwebApi.OrderInput();
  });
  ...
  describe('OrderInput', function() {
    it('should create an instance of OrderInput', function() {
      // uncomment below and update the code to test OrderInput
      //var instane = new ComicStockwebApi.OrderInput();
      //expect(instance).to.be.a(ComicStockwebApi.OrderInput);
    });
